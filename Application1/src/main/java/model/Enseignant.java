...
public class Enseignant  {
	...
	public Enseignant(Long matricule, String nom, String prenom, Gender sexe, Date dateNaissace, String lieuNaissance,
			Situation situationFamille, String conjoint, int enfantCharge, Date dateRecrutment,
   ...
   // without Promotion and Echlon

       public Enseignant(Long matricule, String nom, String prenom, Gender sexe, Date dateNaissace, String lieuNaissance,
			Situation situationFamille, String conjoint, int enfantCharge, Date dateRecrutment,
			String diplomeRecrutment, Department departementAffectation, Etat etatActual) {
		Matricule = matricule;
		Nom = nom;
		Prenom = prenom;
		this.sexe = sexe;
